...
import { deleteStudentByIdAdmin } from "../../../api/studentApi";

function ModalDelete(props) {

    const handleDelete = async (studentId) => {
        try {
            const res = await deleteStudentByIdAdmin(studentId);
            ...
            >
                <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 px-6 pt-10 pb-5">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                        Bạn có chắc chắn muốn xóa học sinh có ID:{" "}
                    ...
                    <div className="flex justify-end gap-3 mt-8">
                        ...
                        <button
                            type="button"
                            onClick={() => handleDelete(props.studentId)}
