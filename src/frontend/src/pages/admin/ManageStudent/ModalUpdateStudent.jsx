...
function ModalUpdateStudent(props) {
    ...
    return (
        <>
          ...
          ${props.isOpen ? "top-1/3 -translate-y-1/2 opacity-100 pointer-events-auto" : "top-0 opacity-0 pointer-events-none"}
          bg-white  rounded-lg shadow-lg w-[50%]`}
            >
                <p className=" text-black text-3xl text-center mb-10">Cập Nhật Thông Tin Học Sinh</p>
