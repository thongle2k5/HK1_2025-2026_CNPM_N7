                    ...
                    <table className="border-collapse border border-gray-300 w-full">
                        <thead className="bg-gray-100">
                            <tr>
                                ...
                                <th className="border border-gray-300 px-4 py-2 text-left">Họ tên phụ huynh</th>
                                <th className="border border-gray-300 px-4 py-2 text-left">Họ tên học sinh</th>
                        ...
                        <tbody>
                            <tr className="hover:bg-gray-50 " >
                                ...
                                <td className="border border-gray-300 px-4 py-2">Nguyễn Văn B</td>
                                <td className="border border-gray-300 px-4 py-2">12A1</td>
                                <td className="border border-gray-300 px-4 py-2">0123456789</td>
                                <td className="border border-gray-300 px-4 py-2">TPHCM</td>
                            ...
                            <tr className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-300 px-4 py-2">Trần Thị B</td>
                                <td className="border border-gray-300 px-4 py-2">Nguyễn Văn C</td>
                                <td className="border border-gray-300 px-4 py-2">12A2</td>
